...
const DeleteChapter = (props: IProps) => {
  const {
    openModelDelete,
    setOpenModelDelete,
    reloadTable,
  ...
  return (
    <>
      <Dialog
        ...
        onClose={() => {
          setOpenModelDelete(false), setIdDelete(""), setCourseId("");
        }}
            ...
            >
              ...
              <div className="bg-gray-700/25 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                ...
                <button
                  ...
                  data-autofocus
                  onClick={() => {
                    setOpenModelDelete(false), setIdDelete("");
                  }}
