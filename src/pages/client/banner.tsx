      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6  py-40 text-white">
        <div className="w-[700px]">
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-4">
            <a
              href="#courses"
              className="px-6 py-3 bg-blue-600 rounded-lg text-white font-semibold hover:bg-blue-700 text-center"
            >
              Khám phá các khóa học
            </a>
            <Link
              to={"/login"}
              className="px-6 py-3 bg-white rounded-lg text-blue-700 font-semibold hover:bg-gray-100 text-center"
            >
